...
Далее приведу несколько примеров собственных решений практический заданий с платформы stepik.org
курса "Введение в Linux".
...
#
# Напишите калькулятор на bash. При запуске ваш скрипт должен ожидать ввода
