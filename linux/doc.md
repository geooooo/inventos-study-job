...
TODO: Повторить что и зачем, касательно ssh, scp
...
#
# Условие: Написать bash скрипт, который выводит текущее время и дату в файл
# /tmp/cron_test. Этот скрипт должен запускаться раз в 2 минуты с использованием crontab.
#
...
TODO: Ознакомиться http://githowto.com/ru
